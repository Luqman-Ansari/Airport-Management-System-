...
Create table PLANET
	...
	personID numeric(9) foreign key references Person,
	corpName varchar(20) foreign key references corp,
	AirplaneID numeric(4) primary key foreign key references owner
	);

	insert into buys_from values(123456789, 'Boeing', 4521);
	insert into buys_from values(123658978, 'Airbus', 4522);
	insert into buys_from values(458712569, 'Boeing', 4523);
	insert into buys_from values(458745852, 'Bombardier', 4524);
	insert into buys_from values(456985632, 'Boeing', 4525);
	insert into buys_from values(653212547, 'Qatar', 4526);
	insert into buys_from values(123658978, 'Airbus', 4538);
	insert into buys_from values(123456789, 'Qatar', 4539);
	insert into buys_from values(452369854, 'Boeing', 4540);
